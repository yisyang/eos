 ...
 *
 *      WARNING
 *          Scott added some hacks to this script on 2012-03-23
 *
 *
 *
 *
...
//--------------------------------------------------------------------------------------------------------------
    ...
    $.extend($.ui.dialog.prototype, {
        ...
        _restorePositionSize: function() {
			this.uiDialog.animate({top:this.options.originalTop, left:this.options.originalLeft, width:this.options.originalWidth, height:this.options.height+this.titlebarHeight+11});
        ...
        restore: function() {
			...
			//Set updater var to ON
			$("#chatbox").height($('#chat_wrapper').height() - 34);
			loadLogEnabled = 1;
			setCookie("rjchatmin",0,365);
        },
        minimize: function() { 
            var self = this;
            ...
            this.uiDialog.animate({bottom:1, left: 1, width: 200, height:this.titlebarHeight},200);
            this.element.hide();
			...
			//Set updater var to OFF
			loadLogEnabled = 0;
			setCookie("rjchatmin",1,365);
        },
        maximize: function() { 
            //Store the original height/width
            var self = this;

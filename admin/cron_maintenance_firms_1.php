<?php
	...
	$settings_world_var = 'su_firms_last_ran_1000';
	$settings_world_var_time = 'su_firms_last_ran_1000_dur';
	$settings_firms_lower_limit = 0;
	$settings_firms_upper_limit = 10001;

<?php
	...
	$settings_world_var = 'su_firms_last_ran_4000';
	$settings_world_var_time = 'su_firms_last_ran_4000_dur';
	$settings_firms_lower_limit = 30000;
	$settings_firms_upper_limit = 90001;

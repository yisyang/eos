...
<?php require 'include/html.php'; ?>
		<title><?= GAME_TITLE ?> - Stock Market - Orders</title>
<?php require 'include/head.php'; ?>
		<script type="text/javascript">
			jQuery(document).ready(function(){
				playerController.playerId = <?= $eos_player_id ?>;
				stockController.showTableBid(1, 'bid', 0, 1);
				stockController.showTableAsk(1, 'ask', 0, 1);
			});
			...
			function doSearch(search){
				...
				if(search !== lastSearch){
					...
					stockController.showTableBid(1, 'bid_search', search);
					stockController.showTableAsk(1, 'ask_search', search);
				}
			}
		</script>
...
?>
	<div id="eos_narrow_screen_padding">
		<div id="stock_submenu" class="default_submenu">
			...
			<a href="stock-orders.php" class="submenu active"><img src="/eos/images/stock_curr_orders.gif" width="36" height="36" alt="[Current Orders]" title="View Current Orders" /></a> 
			&nbsp;&nbsp; 
			...
			<div class="searchbox_holder"><input class="searchbox" onkeyup="initSearch(this.value);" onchange="initSearch(this.value, 1);" placeholder="Search Symbols (in orders)" /></div>
		</div>
		<h3>Bids</h3>
		<div id="stock_bid_top_nav" class="stock_bid_nav_container clearer"></div>
		<table id="stock_bid_table" class="default_table"></table>
		<div class="stock_bid_nav_container"></div>
		<br />
		<h3>Asks</h3>
		<div id="stock_ask_top_nav" class="stock_ask_nav_container clearer"></div>
		<table id="stock_ask_table" class="default_table"></table>
		<div class="stock_ask_nav_container"></div>
	</div>

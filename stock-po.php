...
<?php require 'include/html.php'; ?>
		<title><?= GAME_TITLE ?> - Stock Market - Public Offering</title>
<?php require 'include/head.php'; ?>
		<script type="text/javascript">
			jQuery(document).ready(function(){
				playerController.playerId = <?= $eos_player_id ?>;
				stockController.showTablePO(1, '<?= $view_type ?>', 0, 1);
			});
			...
			function doSearch(search){
				...
				if(search !== lastSearch){
					...
					stockController.showTablePO(1, 'po_search', search);
				}
			}
		</script>
...
?>
	<div id="eos_narrow_screen_padding">
		<div id="stock_submenu" class="default_submenu">
			...
			&nbsp;&nbsp; 
			<a href="stock-po.php" class="submenu active"><img src="/eos/images/stock_po.gif" width="36" height="36" alt="[SE PO]" title="Public Offerings and Buybacks" /></a> 
			&nbsp;&nbsp; 
			...
			<div class="searchbox_holder"><input class="searchbox" onkeyup="initSearch(this.value);" onchange="initSearch(this.value, 1);" placeholder="Search Symbols (in PO)" /></div>
		</div>

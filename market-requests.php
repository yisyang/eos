		...
		<script type="text/javascript">
			...
			function doSearch(search){
				...
				if(search !== lastSearch){
					...
					marketController.showTableRequests(1, 'search', search);
				}
			}
		</script>
...
<?php
	if(!$settings_narrow_screen){
		echo '<img src="/eos/images/title-b2b-req.jpg" style="padding-bottom: 10px;" /><br />';
	}
?>
	<div id="eos_narrow_screen_padding">
		<div id="b2b_submenu" class="default_submenu">
			...
			&nbsp;&nbsp; 
			<a href="market-requests.php?view_type=new" class="submenu <?= $view_type == 'new' ? 'active' : '' ?>"><img src="/eos/images/b2b_req_new.gif" width="36" height="36" alt="[Req A-Z]" title="B2B Requests (Alphabetical)" /></a> 
			<a href="market-requests.php?view_type=alpha" class="submenu <?= $view_type == 'alpha' ? 'active' : '' ?>"><img src="/eos/images/b2b_req_az.gif" width="36" height="36" alt="[Req A-Z]" title="B2B Requests (Alphabetical)" /></a> 
			<a href="market-requests.php?view_type=fact" class="submenu <?= $view_type == 'fact' ? 'active' : '' ?>"><img src="/eos/images/b2b_req_fact.gif" width="36" height="36" alt="[Req Fact]" title="B2B Requests (Filter by Factory)" /></a> 
			<a href="market-requests.php?view_type=cat" class="submenu <?= $view_type == 'cat' ? 'active' : '' ?>"><img src="/eos/images/b2b_req_cat.gif" width="36" height="36" alt="[Req Cat]" title="B2B Requests (Filter by Category)" /></a> 
			<a href="market-requests.php?view_type=my" class="submenu <?= $view_type == 'my' ? 'active' : '' ?>"><img src="/eos/images/b2b_req_my.gif" width="36" height="36" alt="[Req My]" title="B2B Requests (My Requests)" /></a> 
			&nbsp;&nbsp; 
		...
		<table id="b2b_table" class="default_table market_requests compact"></table>
